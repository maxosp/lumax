...
import ScoreDropdown from '@/pages/bank/olympiad-tasks/list/parts/modals/tasks-update/parts/score-dropdown/ScoreDropdown.vue'
import Switchers from '@/pages/bank/olympiad-tasks/list/parts/modals/tasks-update/parts/switchers/Switchers.vue'
...
import {
  ...
  cancelForm,
  $tasksIdsErrorModule,
} from '@/pages/bank/olympiad-tasks/list/parts/modals/tasks-update/tasks-update-modal.model'
