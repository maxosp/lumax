...
<script lang="ts">
import Vue from 'vue'
import ResizableBlock from '@/pages/bank/test-tasks/tasks/moving-images-on-image-input-answer/parts/drag-and-drop-image-container/resizable/ResizableBlock.vue'
