...
import { DraggableImage, DroppableImage } from '@/pages/bank/test-tasks/create/tasks/types'
import { $droppableImages } from '@/pages/bank/test-tasks/create/tasks/moving-images-on-image-input-answer/moving-images-on-image-answer-form.model'
