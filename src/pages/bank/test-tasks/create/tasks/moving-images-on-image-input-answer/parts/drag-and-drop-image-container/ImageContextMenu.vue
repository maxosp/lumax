...
import { Position, Size } from '@/pages/bank/test-tasks/create/tasks/types'
import SizeInput from '@/pages/bank/test-tasks/create/tasks/moving-images-on-image-input-answer/parts/drag-and-drop-image-container/SizeInput.vue'
import ColorPicker from '@/pages/bank/test-tasks/create/tasks/moving-images-on-text-input-answer/parts/areas-for-attaching-images/ColorPicker.vue'
