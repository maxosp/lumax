...
import Prerequisites from '@/pages/dictionary/themes/create/parts/prerequisites/Prerequisites.vue'
import SubjectDropdown from '@/pages/dictionary/themes/create/parts/subjects/SubjectDropdown.vue'
import ClassDropdown from '@/pages/dictionary/themes/create/parts/class/ClassDropdown.vue'
import Themes from '@/pages/dictionary/themes/create/parts/themes/Themes.vue'
import {
  $themeTitle,
  resetThemeTitle,
  themeTitleChanged,
