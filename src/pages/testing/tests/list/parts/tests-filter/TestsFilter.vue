<template>
  ...
  >
    ...
    <div class="row">
      <TypeDropdown class="half-second" @setItem="val => setItem({'generator': val})" />
      <StatusDropdown class="half-third" @setItem="val => setItem({'status': val})" />
    </div>
    <div class="row">
      <GroupDropdown class="half-second" @setItem="val => setItem({'group': val})" />
      <div class="buttons">
        <div class="btn">
          <BaseButton
            small
...
import { dropdownComponents } from '@/pages/testing/tests/list/parts/tests-filter/parts/dropdown-components'
import {
  reset,
  toggleVisibility,
...
export default Vue.extend({
  ...
  components: {
    ...
    GroupDropdown: dropdownComponents.GroupDropdown,
  },
  props: {
