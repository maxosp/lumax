...
import CorrectAnswerForm from '@/pages/task-creation/test/tasks/CommonListTextAnswer/parts/CorrectAnswerForm.vue'
import {
  $wording,
  setWording,
  $containing,
  ...
  $language,
  setLanguage,
} from '@/pages/task-creation/test/tasks/CommonListTextAnswer/common-list-text-answer.model'

export default Vue.extend({
  name: 'CommonListTextAnswer',
  components: {
    BaseTextarea,
    Wysiwyg,
    AudioFiles,
