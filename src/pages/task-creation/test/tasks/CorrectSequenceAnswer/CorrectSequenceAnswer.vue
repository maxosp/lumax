...
import CorrectAnswerForm from '@/pages/task-creation/test/tasks/CorrectSequenceAnswer/parts/CorrectAnswerForm.vue'
import {
  $wording,
  setWording,
  $containing,
  ...
  $language,
  setLanguage,
} from '@/pages/task-creation/test/tasks/CorrectSequenceAnswer/correct-sequence-answer.model'

export default Vue.extend({
  name: 'CorrectSequenceAnswer',
  components: {
    BaseTextarea,
    Wysiwyg,
    AudioFiles,
