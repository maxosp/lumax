export default [
  { name: 'SHORT_CLOSED_ANSWER', title: 'Задание с вводом короткого закрытого ответа' },
  {
  ...
  { name: 'MULTIPLE_CHOICE_ONE_ANSWER', title: 'Задание с выбором одного правильного ответа' },
  { name: 'BROAD_OPEN_ANSWER', title: 'Задание с вводом развернутого открытого ответа' },
  { name: 'COMMON_LIST_STRING_ANSWER', title: 'Задание с одним общим выпадающим списком в строке' },
  {
    name: 'CORRECT_SEQUENCE_ANSWER',
    title: 'Задание на установление правильной последовательности с перемещением элементов',
  },
  { name: 'CONNECT_LINES_ANSWER', title: 'Задание на сопоставление с соединением частей линией' },
  {
  ...
  { name: 'COMMON_LIST_TEXT_ANSWER', title: 'Задание с общим выпадающим списком в тексте' },
  {
  ...
  { name: 'COLOR_HIGHLIGHT_ANSWER', title: 'Задание с цветовым выделением в тексте' },
]
